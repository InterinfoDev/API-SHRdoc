...
| 特定員工行事曆 | appEmployeeCalendarList | N | 取得特定員工行事曆資訊 | Kevin |  |
| 個人行事曆詳細 | appEmployeeCalendarQuery | N | 取得員工個人行事曆特定事件詳細資料 | Kevin |  |
| 異動行事曆 | appEditEmployeeCalendar | N | 取得員工個人行事曆特定事件詳細資料 | Kevin |  |
